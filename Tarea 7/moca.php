...
<div class="container">
    ...
    <div class="row mt-3 mr-5">
        ...
        <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <img class="w-100 animate__fadeInDown animate__animated" style="border-radius: 9px; border-style: solid; border-color: black" src="images/moca.jpg" alt="Recinto de Moca">

            <div class="lead animate__fadeIn animate__animated animate__fast animate__delay-1s">
                <p>Carretera Duarte, Moca, República Dominicana.</p>
                <p><b>Teléfonos:</b> (809) 578-2542 y 578-4343</p>
                <p><b>Apartados de Correo:</b> 406</p>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" bgcolor="#FFFFCC">
                                            <font size="1" face="Arial, Helvetica, sans-serif"> INGIENERIA </font>
                                        </td>
                                        <td valign="middle" align="center" bgcolor="#FFFFCC">
                                    ...
                                    <tr>
                                        <td colspan="2" valign="middle" bgcolor="#FFFFCC" height="24">
                                            ...
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="1">EDUCACION MATEMATICA</font>
                                        </td>
